...
const CreateAppCard = (
  ...
  return (
    ...
    >
      <a ref={ref} className='group flex grow cursor-pointer items-start p-4' href={`${BASE_PATH}/datasets/create`}>
      ...
      <a className='group flex cursor-pointer items-center gap-1 rounded-b-xl border-t-[0.5px] border-divider-subtle p-4' href={`${BASE_PATH}/datasets/connect`}>
