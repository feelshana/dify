...
const Chat: FC<ChatProps> = ({
  ...
  const onsendWithScrollToBottomRef = useRef<OnSend>()
  useEffect(() => {
    onsendWithScrollToBottomRef.current = onsendWithScrollToBottom
  }, [onsendWithScrollToBottom])
  const onAutoInputsChangeRef = useRef<any>()
  useEffect(() => {
